...
# you could use mutate(response = na_if("ctrl +8", NA, response)) to remove the response that does not correspond to a likert response but if there are multiple unwanted answers then it takes more time than to just filter after wanted responses instead
